...
func ParseResponse(bytes []byte, issuer *x509.Certificate, verifySignature bool) (*Response, error) {
	return ParseResponseForCert(bytes, nil, issuer, verifySignature)
}
...
func ParseResponseForCert(bytes []byte, cert, issuer *x509.Certificate, verifySignature bool) (*Response, error) {
